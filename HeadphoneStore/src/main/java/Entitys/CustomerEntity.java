...
public class CustomerEntity implements Serializable {
	...
	public CustomerEntity(String firstname,String secondname,String email,String password,String sity,String street,int house,int apartment,String phoneNumber, String zipCode) {
		this(firstname, secondname, email, password, sity, street, house, apartment, phoneNumber);
