...
@JMSDestinationDefinitions(value = {
	@JMSDestinationDefinition(
	    name = "java:jboss/exported/jms/queue/BigManagerMDB",
	    interfaceName = "javax.jms.Queue",
	    destinationName = "BigManagerMDBDestination"
	)
})
...
public class BigManagerMDB implements MessageListener {
	@Inject
	...
	public void onMessage(Message message) {
		...
		try {
			...
			System.out.println("   Hello   form   *************       BigManagerMDB          +++++++++++++++++      " + stringOrderId );
